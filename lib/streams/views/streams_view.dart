...
class VideosListView extends StatefulWidget {
  ...
  const VideosListView({super.key, required this.fromHome});
        ...
        child: Stack(
          children: [
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            _navigateTo(() => ScrollableFullVideoScreen(
                                    ...
                                    AspectRatio(
                                      ...
                                      child: Obx(() {
                                        return controller.thumbnailPaths[
                                                ...
                                                null
                                            ? Image.file(
                                                File(controller.thumbnailPaths[
                                                    video.url]!),
                                                fit: BoxFit.cover,
            ...
            Positioned(
              ...
              child: Obx(() => SizedBox(
                    height:
                        showFilterDropdowns.values.contains(true) ? 250 : 36,
                    child: ListView(
