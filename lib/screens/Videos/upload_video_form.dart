...
// 1. Add this to your state class
  ...
  void initState() {
    ...
    nameController.addListener(() {
      ...
      if (nameController.text.isEmpty) {
        // Jab restaurant name empty ho jaye to address fields clear kar dein
        setState(() {
        ...
        // Normal filtering when user types
        setState(() {
  ...
  Widget _buildRestaurantField() {
    return Column(
      ...
      children: [
        ...
        if (filteredRestaurants.isNotEmpty && nameController.text.isNotEmpty)
          Container(
            width: 604,
            decoration: BoxDecoration(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  title: Text(restaurant.resName),
                  onTap: () {
                    setState(() {
                      nameController.text = restaurant.resName;
                      streetController.text = restaurant.address;
                      cityController.text = restaurant.city;
                      stateController.text = restaurant.country;
                      zipCodeController.text = restaurant.zipCode;
                      filteredRestaurants.clear(); // hide suggestions
                    });
                  },
                );
              },
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: TextButton(
                          ...
                          style: TextButton.styleFrom(
                            padding: EdgeInsets
                                .zero, // Important: remove internal padding
                          ...
                          child: Align(
                            alignment: Alignment
                                .centerLeft, // Make sure the text aligns left
                            child: Text(
                              "Cancel",
                              style: simpleText.copyWith(
                                  fontSize: 20,
                      ...
                      // Upload/Update Button - Right Aligned
                      Obx(
                        () => SizedBox(
                          width: 150,
                          height: 40,
                            ...
                            onPressed: videoController.isUploading.value
                                ...
                                : () async {
                                    ...
                                    if (widget.isEdit) {
                                      ...
                                      videoController.isEditMode.value = false;
                                      videoController.isUploadMode.value =
                                          false;

                                      if (videoController.pickedVideo.value !=
                                          null) {
                                        final result = await videoController
                                            .uploadVideoOnly(
                                          pickedFile: videoController
                                              .pickedVideo.value!,
                                        );
