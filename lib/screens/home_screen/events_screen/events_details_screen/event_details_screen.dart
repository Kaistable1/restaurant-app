         ...
         Stack(
           children: [
             Container(
               ...
               decoration: BoxDecoration(
                 image: DecorationImage(
                   image: AssetImage('assets/images/events_details_img.png')
                 )
               ),
             ),
             AppBar(
               ...
               actions: [
                 Obx(() => Padding(
                   ...
                   child: GestureDetector(
                     onTap: () => controller.toggleBookmark(), // Toggle bookmark
                     child: Image.asset(
             ...
             Positioned(
               bottom: 16,
               left: 120,
               child: ClipRRect( // Prevents blur from overflowing
                 ...
                 child: BackdropFilter(
                   ...
                   child: GestureDetector(
                     ...
                     child: Container(
                       ...
                       width: 151,
                       decoration: BoxDecoration(
                         color: AppColors.whiteColor.withOpacity(0.2), // Adjust opacity
                         borderRadius: BorderRadius.circular(4),
                       ),
                       child: Center(
                         child: Text(
                           "Sell all 8 photos", // Add text if needed
                           style: TextStyle(
                               color: AppColors.primaryColor,
                             fontSize: 16,
  ...
  return Column(
    ...
    children: [
      Padding(
        ...
        child: Align(
          ...
          child: Text(
            text,
            style: TextStyle(
                color: index == selectIndex ? AppColors.primaryColor : Color(0xFF4F5A57),
      ...
      if (index == selectIndex) ...{
        Container(
          width: selectIndex==2?150:109, // Adjust the width to your desired value
          height: 4,
