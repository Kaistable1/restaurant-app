...
class FilterController extends GetxController {
  ...
  void updateAvailableCitiesForState(String state) {
    ...
    if (availableCities.isNotEmpty) {
      //
      filterOptions['City'] =
          availableCities.toList(); // Sync with filterOptions
    } //
  ...
  void toggleFilter(String category, String option) {
    ...
    switch (category) {
      ...
      case 'Vibes':
        ...
        break;
      case 'Experience':
        filterSelectionController.selectedExperience.value =
            selectedFilters[category]?.toList() ?? [];
        break;
      case 'Entertainment':
  ...
  void syncFiltersWithSelectionController() {
    filterSelectionController.selectedFilters.value =
        selectedFilters['Cuisines']?.toList() ?? [];
    filterSelectionController.selectedAtmosphere.value =
        selectedFilters['Vibes']?.toList() ?? [];
    filterSelectionController.selectedExperience.value =
        selectedFilters['Experience']?.toList() ?? [];
    filterSelectionController.selectedEntertainment.value =
        selectedFilters['Entertainment']?.toList() ?? [];
    filterSelectionController.selectedDietary.value =
        selectedFilters['Dietary']?.toList() ?? [];
