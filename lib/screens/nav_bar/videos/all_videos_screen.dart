...
import 'package:kaistable_website/screens/nav_bar/videos/saved_video_screen.dart';
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => SavedVideosScreen()),
                );
              },
              child: Row(
                children: const [
                    ...
                    child: TextField(
                                            ...
                                            onPressed: () {
                                              videoController
                                                ...
                                                selectedAtmospheres:
                                                    videoController
                                                        .selectedAtmosphere,
                                                selectedCuisine: videoController
                                                    .selectedCuisine,
                                                selectedExperience:
                                                    videoController
                                                        .selectedExperience,
                                                searchQuery: videoController
                      ...
                      onChanged: (value) {
                        videoController.applyAllFiltersAndSearch(
                          ...
                          selectedAtmospheres:
                              videoController.selectedAtmosphere,
                          selectedCuisine: videoController.selectedCuisine,
                          selectedExperience:
                              videoController.selectedExperience,
                          searchQuery: value!,
                        );
