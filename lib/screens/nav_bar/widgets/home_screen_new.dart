...
class _HomeScreenNewState extends State<HomeScreenNew> {
  ...
  Widget buildRestaurantCard(RestaurantModel restaurant) {
    ...
    return GestureDetector(
      ...
      child: Container(
        width: cardWidth,
        height: cardWidth * 1.5, // Maintain aspect ratio (1.5:1 height to width)
        decoration: BoxDecoration(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: (cardWidth * 0.1).clamp(12.0, 14.0), // Responsive font size
      ...
      children: [
        Row(
          children: [
            CircleAvatar(
              radius: 20,
              backgroundImage: AssetImage('assets/images/Ellipse 19.png'), // Placeholder
            ),
            const SizedBox(width: 8),
            Expanded(
              child: Row(
