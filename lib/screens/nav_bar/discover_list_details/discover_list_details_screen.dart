...
class DiscoverListDetailScreen extends StatefulWidget {
  ...
  DiscoverListDetailScreen({Key? key, required this.discoverListModel}) : super(key: key);

  @override
  State<DiscoverListDetailScreen> createState() => _DiscoverListDetailScreenState();
}

class _DiscoverListDetailScreenState extends State<DiscoverListDetailScreen> with WidgetsBindingObserver {
  final DiscoverListDetailsController listDetailsController = Get.put(DiscoverListDetailsController());
  ...
  void initState() {
    ...
    listDetailsController.loadSelectedRestaurants(widget.discoverListModel.restaurantIdsList);
  ...
  Widget build(BuildContext context) {
    ...
    ()=> listDetailsController.gettingRestaurants.value ?
        Center(child: SizedBox(height: 32, width: 32, child: CircularProgressIndicator(color: AppColors.primaryColor,),),)
        : ListView.builder(
      padding: EdgeInsets.zero,
                  itemCount: listDetailsController.selectedRestaurants.length,
                  itemBuilder: (context, index) {
                    final restaurant = listDetailsController.selectedRestaurants[index];
