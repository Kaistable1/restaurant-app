  ...
  Widget _featuredCategory() {
    ...
    return Column(
      ...
      children: [
        ...
        // Original content with loading state
              ...
              builder: (context, featuredIDSnapshot) {
                ...
                return StreamBuilder<List<RestaurantModel>>(
                  ...
                  builder: (context, allRestaurantsSnapshot) {
                    ...
                    // Your original content implementation here
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 150), // Placeholder space
        ],
      ),
    );
  }
...
//.................................
  ...
  Widget _buildTrendingSection() {
    ...
    return Obx(() {
      final trendingList = homeController.trendingRestaurants;

      if (!homeController.hasInitialized.value) {
        return Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
      ...
      final featuredRestaurant = trendingList.first;
                ...
                GestureDetector(
                  onTap: () {
                    Get.to(() => TrendingRestaurantsPage(
                          filteredRestaurants: trendingList,
                          activeVibes: filterController.selectedVibes,
                          activeExperiences:
                              filterController.selectedExperiences,
                          activeCuisines: filterController.selectedCuisines,
                        ));
                  },
                  child: Text(
                    'See more',
            ...
            TrendingRestaurantCard(
              ...
              onFilterTap: () {
                ...
                showModalBottomSheet(
                  ...
                  builder: (_) => HomeFilterBottomsheet(filters: allFilters),
                );
              },
            ),
          ],
...
//       if (featuredRestaurant.distanceInMiles != null)
//         Positioned(
//           bottom: 0,
//           left: 0,
//           right: 0,
...
//                         const SizedBox(width: 6),
//                         Text(
//                           '${featuredRestaurant.distanceInMiles!.toStringAsFixed(1)} mi',
//                           style: TextStyle(
//                             fontSize: 14,
//                             fontWeight: FontWeight.w500,
//                             color: Colors.white,
...
//     return Obx(() {
//       // Memoize filter values to prevent unnecessary rebuilds
...
//       final restaurantsStream = homeLocationController.getTrendingRestaurants(
//         vibes: vibes,
...
//             debugPrint('Error during stream call ${snapshot.error}');
...
//           // Initialize selectors after first frame
//           WidgetsBinding.instance.addPostFrameCallback((_) {
...
//             featuredRestaurant: filteredRestaurants.first,
...
// // Extracted loading section widget
...
//     required RestaurantModel featuredRestaurant,
//     required List<RestaurantModel> filteredRestaurants,
...
//           ),
//           const SizedBox(height: 16),
//           _buildFeaturedRestaurantCard(featuredRestaurant),
//         ],
//       ),
//     );
//   }

// // Extracted featured restaurant card widget
...
//       child: Stack(
//         children: [
//           // Optimized image loading with placeholder and error widget
//           ClipRRect(
//             borderRadius: BorderRadius.circular(12),
//             child: Image.network(
...
//                 // Filter Button
//                 GestureDetector(
//                   onTap: () => _showFiltersBottomSheet(context, restaurant),
//                   child: Image(
//                     image: AssetImage("assets/images/filter.png"),
//                     width: 20,
//                     height: 20,
...
//                 // Direction Button
//                 GestureDetector(
//                   onTap: () => _openDirections(restaurant),
//                   child: Image(
...
//     final allFilters = controller.getAllFilters(restaurant);
...
//       final restaurantName = Uri.encodeComponent(restaurant.resName);
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () =>
                            Get.to(NearByAll(filteredRestaurants: restaurants)),
                        child: Text(
                          'See more',
                          style: TextStyle(
                            color: AppColors.primaryColor,
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            widget.onApply(
                                _tempSelected); // Apply selected filters to controller

                            // 🔁 Reset trending so it reloads with new filters
                            final homeController =
                                Get.find<HomeLocationController>();
                            final filterController =
                                Get.find<HomeFilterSearchController>();

                            homeController.resetTrendingFlag();
                            homeController.loadTrendingRestaurants(
                              vibes: filterController.selectedVibes,
                              // ✅ FIXED
                              experiences: filterController.selectedExperiences,
                              cuisines: filterController.selectedCuisines,
                            );
