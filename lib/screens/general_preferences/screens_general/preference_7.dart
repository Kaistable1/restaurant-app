...
class Preference7 extends StatelessWidget {
  Preference7({super.key, this.isSequential = true});
          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                ...
                shrinkWrap: true,
                primary: false,
                itemCount: controller.preferences7.length,
                itemBuilder: (context, index) {
                  final preference = controller.preferences7[index];
                  return Obx(() {
                    final isSelected = controller.selectedPreferences7
                        .contains(preference["name"]);
                    final isOther = preference["name"] == "Other";

                    return GestureDetector(
                      onTap: () =>
                          controller.toggleSelection7(preference["name"]!),
