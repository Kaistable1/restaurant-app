...
Future<bool> addPrivacy() async {
  ...
  await showDialog(
    ...
    builder: (BuildContext context) {
      final AboutAppController _controller =
      Get.put(AboutAppController());
      final TextEditingController textEditingController =
      TextEditingController(text: _controller.aboutAppText.value);
      double screenWidth = MediaQuery.of(context).size.width;
      bool isLargeScreen = screenWidth > 1600;
      return Dialog(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: CustomButton(
                        ...
                        ontapp: () {
                          _controller
                              .updateAboutAppText(textEditingController.text);
