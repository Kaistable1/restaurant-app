...
class AddDiscoverListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (controller.selectedDiscoverListModel != null) {
      controller.discoverListNameController.text =
          controller.selectedDiscoverListModel!.name;
      controller.discoverListByController.text =
          controller.selectedDiscoverListModel!.by;
      controller.discoverListDescController.text =
          controller.selectedDiscoverListModel!.description;

      controller.imageUrl = controller.selectedDiscoverListModel!.image.obs;
      controller.loadSelectedRestaurants(
          controller.selectedDiscoverListModel!.restaurantIdsList);
    }
                  ...
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: DropdownSearch<String>(
                            ...
                            // State is now optional, no validator needed
                        ...
                        Expanded(
                          child: CustomTextField(
                            ...
                            hintText: controller.selectedState.value.isNotEmpty
                                ? 'Enter or select city (optional)'
                                : 'Select State First (optional)',
                            // City is now optional, no validator needed
                    ...
                    _buildMultiSelectDropdown(
                      ...
                      onChanged: (List<String> val) =>
                          controller.selectedVibes.value = val,
                    ),
                    const SizedBox(height: 10),
                    _buildMultiSelectDropdown(
                      label: 'Experiences',
                      ...
                      onChanged: (List<String> val) =>
                          controller.selectedExperiences.value = val,
                    ),
                    const SizedBox(height: 10),
                    _buildMultiSelectDropdown(
                      label: 'Entertainment',
                      ...
                      onChanged: (List<String> val) =>
                          controller.selectedEntertainment.value = val,
                    ),
                    const SizedBox(height: 10),
                    _buildMultiSelectDropdown(
                      label: 'Cuisines',
                      ...
                      onChanged: (List<String> val) =>
                          controller.selectedCuisines.value = val,
                    ),
                    const SizedBox(height: 10),
                    _buildMultiSelectDropdown(
                      label: 'Dietary',
                      ...
                      onChanged: (List<String> val) =>
                          controller.selectedDietary.value = val,
                    ),
                    const SizedBox(height: 20),
                    Text(
                      'Select Restaurant',
                      ...
                      () => controller.selectedRestaurants.isEmpty
                          ...
                          : SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount:
                                    controller.selectedRestaurants.length,
                                itemBuilder: (context, index) {
                                  final restaurant =
                                      controller.selectedRestaurants[index];
                                  return Padding(
                            ...
                            if (formKey.currentState!.validate()) {
                              ...
                              if (controller.isEdit.value) {
                                await controller.updateDiscoverList(
                                    docID: controller
                                        .selectedDiscoverListModel!.docId);
                                return;
                              } else {
