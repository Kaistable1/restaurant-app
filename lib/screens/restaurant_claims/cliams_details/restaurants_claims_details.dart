...
class RestaurantsClaimsDetails extends StatelessWidget {
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            width: isLargeScreen
                                ? 680
                                : 500, // Fixed width as per your code
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                left: isLargeScreen ? 140 : 90.0),
                            child: CustomButton(
                                ontapp: () async {
                                  if (formKey.currentState!.validate()) {
                                    await controller.approvedResturnatsClaims();
                                    controller.passwordController.clear();
                                    drawerController.viewClaimsDetails.value =
                                        false;
                                  }
                                },
                                width: 339,
  ...
  SizedBox emailSenderWidget(
      bool isLargeScreen, RestaurantClaimsModel claimsModel) {
    return SizedBox(
      width: isLargeScreen ? 680 : 500,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          TextAndFieldsOrDropDown(
            ...
            // controller: ,
            //
            fieldController: TextEditingController(text: claimsModel.email),
            isDropDown: false,
            fieldValidator: (value) =>
          ...
          TextAndFieldsOrDropDown(
            ...
            isDropDown: false,
            fieldValidator: (value) =>
                value!.isEmpty ? 'Message required' : null,
            maxLines: 5,
          ),
          SizedBox(height: 20),
          Align(
            alignment: Alignment.center,
            child: /*controller.isSending.value?Center(child: CircularProgressIndicator()): */
                CustomButton(
              ontapp: () async {
                if (controller.emailSubjectController.text.isNotEmpty &&
                    controller.emailMessageController.text.isNotEmpty) {
