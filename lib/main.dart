...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  debugPrint("Handling a background message: ${message.messageId}, Title: ${message.notification?.title}");
}
...
void main() async {
  ...
  await  SendNotificationService().initialize(); // Initialize FCM + local notifications().initFirebaseNotification();
